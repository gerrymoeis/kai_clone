...
func printBack4appSteps(reader *bufio.Reader) error {
	...
	fmt.Println("──────────────────────────────────────────")
	fmt.Println("1. In Back4app dashboard, click 'Build new app'")
	fmt.Println("2. Select 'Container as a Service'")
	fmt.Println("3. Click 'Connect GitHub account'")
	fmt.Println("4. Authorize Back4app to access your repositories")
	fmt.Println("5. Select the repository for this project")
	fmt.Println()
	...
	fmt.Println("WHY GITHUB INTEGRATION:")
	fmt.Println("  Back4app auto-deploys when you push to your main branch.")
	fmt.Println("  This creates a true CI/CD pipeline with zero configuration.")
	fmt.Println()
	fmt.Print("✓ Repository connected? Press ENTER to continue...")
	_, _ = reader.ReadString('\n')

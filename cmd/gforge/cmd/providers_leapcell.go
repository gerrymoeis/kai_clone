...
func leapcellStep4Configure(reader *bufio.Reader) error {
	...
	fmt.Println("")
	fmt.Println("──────────────────────────────────────────")
	fmt.Println("Install Command (run before build):")
	fmt.Println("  go install github.com/a-h/templ/cmd/templ@latest && go install github.com/bep/gotailwindcss/v2@latest")
	fmt.Println("")
	fmt.Println("──────────────────────────────────────────")
	fmt.Println("Build Command:")
	fmt.Println("  templ generate && gotailwindcss -i app/styles/input.css -o app/styles/output.css --minify && go build -o server ./cmd/server")
	fmt.Println("")
	fmt.Println("──────────────────────────────────────────")
